...
const Testimonials = () => {
  return (
    <div className="h-full w-full overflow-hidden md:py-12 py-6  md:px-20 px-6 font-Atkinson">
        ...
        <div>
          ...
          >
            {[...testimonials].map((testimonial, index) => (
              <div className="flex items-center  justify-center md:px-10 w-full font-Atkinson shadow-md">
